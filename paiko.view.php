 ...
 * particular, you can set here the values of variables elements defined in paiko_paiko.tpl (elements
...
class view_paiko_paiko extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "paiko_paiko", "myblock" );
